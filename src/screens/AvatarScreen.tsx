    ...
    return (
        <SafeAreaView className="bg-white flex-1 items-center">
            ...
            <View className="flex-1 items-center bg-white">
                        ...
                        >
                            {image ? (
                                ...
                                <View className="items-center">
                                    ...
                                    <Text className="font-bold text-lg text-slate-500">Add Image</Text>
                                </View>
                            )}
                        </Pressable>
                ...
                <View className="mt-2 w-screen p-5">
                    <Pressable className="bg-green-600 h-14 justify-center items-center rounded-full">
                        <Text className="text-slate-100 dark:text-slate-100 font-bold text-2xl">Next</Text>
                    </Pressable>
                </View>
            </View>
        </SafeAreaView>
